...
const {COMMON, LOAN_TYPE_TABLE, AGENT_LOAN_TYPE_TABLE, LANGUAGE_TABLE} = require("../../constants/const");
...
module.exports = {
    ...
    isLoanTypeExist: async (loanName) => {
        return (await knex(LOAN_TYPE_TABLE.NAME).select(COMMON.SELECT_ALL)
            .where(LOAN_TYPE_TABLE.LOAN_NAME, `${loanName}%`))[0]
    },
